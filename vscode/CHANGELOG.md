...
-  Switch to *t32-language-server* v0.14.2.
...
-  Switch to *t32-language-server* v0.14.1.
-  List default configuration overrides in readme.
...
-  Add new configuration settings for directory configuration:
