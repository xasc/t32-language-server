...
use crate::{
    config::SemanticTokenEncoding,
    ls::doc::{GlobalMacroDefIndex, TextDoc, TextDocData, TextDocs},
    protocol::{
        Location, LocationLink, Position, Range as LRange, SemanticTokens, SemanticTokensLegend,
        Uri,
    },
    t32::{
        FindMacroRefsLangContext, FindRefsLangContext, GotoDefLangContext, MacroDefinition,
        MacroDefinitionResult, MacroScope, NodeKind, SemanticToken, Subroutine,
        do_syntax_highlighting, do_syntax_highlighting_in_range, find_command_file_target,
...
#[derive(Debug)]
struct SemanticTokenAbsoluteEncoding(pub SemanticTokenIntegerEncoded);

#[derive(Debug)]
struct SemanticTokenRelativeEncoding(pub SemanticTokenIntegerEncoded);
...
pub fn capture_semantic_tokens_full_doc(
...
pub fn capture_semantic_tokens_doc_range(
    legend: SemanticTokensLegend,
    encoding: SemanticTokenEncoding,
    textdoc: TextDocData,
    range: LRange,
...
mod tests {
    ...
    use crate::{
        ...
        protocol::{Range as LRange, TextDocumentItem},
